...
namespace EcommerceAPI.Services
{
    public class AuthService
    {
        ...
        public void Register(RegisterRequest request)
        {
            ...
            bool emailExists = _authRepository.EmailExists(request.Email);
        ...
        public LoginResult Login(LoginRequest request)
        {
            ...
            var token = GenerateJwtToken(user.ClientId, user.ClientName);
        ...
        private string GenerateJwtToken(int clientId, string name)
        {
